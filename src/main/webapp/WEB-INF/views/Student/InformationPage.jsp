...
<body>
	...
	<div class="container">
		...
		<div class="student-info-container">
			<img src="감자 (2).png" alt="학생 사진" class="student-photo">
			<div class="student-info">
				<p><strong>상태:</strong> 수료중</p>
				<p><strong>성별:</strong> 남성</p>
				<p><strong>생년월일:</strong> 1994-01-01</p>
				<p><strong>이메일:</strong> moon@soldesk.com</p>
				<p><strong>전화번호:</strong> 010-1234-5678</p>
				<p><strong>팀:</strong> 달다구리</p>
